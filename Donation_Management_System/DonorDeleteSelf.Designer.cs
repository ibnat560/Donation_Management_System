namespace Donation_Management_System
{
    partial class DonorDeleteSelf
    {
        ...
        private void InitializeComponent()
        {
            ...
            label6.Location = new Point(160, 207);
            label6.Margin = new Padding(4, 0, 4, 0);
            label6.Name = "label6";
            label6.Size = new Size(782, 23);
            label6.TabIndex = 11;
            label6.Text = " If you wish to retrieve your account again, you have to take help of an admin or a volunteer.";
            // 
            // DonorDeleteSelf
            // 
            ...
            MaximizeBox = false;
            Name = "DonorDeleteSelf";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "DonorDeleteSelf";
            ResumeLayout(false);
            PerformLayout();
        }
